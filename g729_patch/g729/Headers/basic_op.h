...
****************************************************************************************/
/****************************************************************************************
Simone (simone@piemontewireless.net) 02-02-2010
I've patched the mult() function, replacing the ITU standard original code,
becouse there is a problem in the (assembler) optimized function that cause a 
EXC_BAD_ACCESS exception in the iPhone SDK3.1.2
This is the fast solution but a better one should be re-optimize this function
in a working way for SDK3.1.2
Added also the sature() function, used by mult().
****************************************************************************************/
